...
if __name__ == "__main__":
    ...
    print(f"PyMetaTwin authored by Cerbersec. This script is a modified version of the original script.")
    print(f"[+] Copying metadata from {source_file} to {target_file}")
